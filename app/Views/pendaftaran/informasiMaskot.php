    ...
    <div class="col-sm-6" data-aos="zoom-in-up">
        <div class="box box-solid">
            ...
            <div class="box-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <p>Terima Kasih Sudah Melakukan Pendaftaran <strong>DIFEST 2022</strong> Di Jenis Perlombaan <strong>Desain Maskot</strong></p>
                ...
                <div class="row JustifyCenter">
                    ...
                    <div class="col-md-4">
                        <center>
                            <a href="https://wa.link/edfvb5" class="btn btn-social btn-success" width="50%">
